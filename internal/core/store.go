	...
	return State{
		Config: Config{
			...
			Harnesses: map[string]Harness{
				"opencode": {Command: "opencode", Mode: "interactive", DisplayName: "OpenCode", BusyPatterns: []string{"thinking", "working"}, ApprovalPatterns: []string{"allow", "permission"}, SupportsJSONEvents: true},
				"claude":   {Command: "claude", Mode: "interactive", DisplayName: "Claude Code", BusyPatterns: []string{"Working", "esc to interrupt"}, ApprovalPatterns: []string{"Do you want to", "Allow this command"}},
				"codex":    {Command: "codex", Mode: "interactive", DisplayName: "Codex", BusyPatterns: []string{"working", "thinking"}, ApprovalPatterns: []string{"approve", "permission"}},
				"pi":       {Command: "pi", Mode: "interactive", DisplayName: "Pi", BusyPatterns: []string{"working", "thinking"}, ApprovalPatterns: []string{"approve", "permission"}},
			},
		},
